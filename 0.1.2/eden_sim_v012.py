...
Notas:
    Esta versión es una base 0.1.2 con símbolos por especie y fauna inicial equilibrada.
...
class World:
    ...
    def render(self) -> None:
        ...
        print(color("EDEN SIM 0.1.2 — especies visibles y fauna inicial equilibrada", "cyan"))
        print(
