...
Notas:
    Esta versión es una base 0.1.3 con ventana gráfica, consola de eventos, comandos y registro relevante.
...
class World:
    ...
    def render(self) -> None:
        ...
        print(color("EDEN SIM 0.1.3 — ventana gráfica, consola de eventos y comandos", "cyan"))
        print(
...
def draw_gui(world: World, pygame, screen, font, small_font) -> None:
    ...
    y = draw_text(screen, font, "EDEN SIM 0.1.3", panel_x, y, (80, 220, 255))
...
def run_pygame_simulation(world: World) -> None:
    ...
    pygame.init()
    pygame.display.set_caption("Eden Sim 0.1.3")
