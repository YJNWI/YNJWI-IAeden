...
Notas:
    Esta versión es una base 0.1.1 con supervivencia inicial ajustada.
...
class World:
    ...
    def render(self) -> None:
        ...
        print(color("EDEN SIM 0.1.1 — IA neuronal evolutiva, supervivencia ajustada", "cyan"))
        print(
