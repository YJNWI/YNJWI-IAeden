...
Notas:
    Esta es la versión 1.4.1: selector de tamaño de mapa, estructuras marrones y comandos fluidos safeinput.
...
def install_runtime_state(world: World) -> None:
    ...
    world.smap_viewer_name = "viewer_v141.html"
...
def draw_overview_screen(stdscr, world: World, command_buffer: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, f"EDEN SIM v1.4.1 — MAPA GLOBAL {MAP_W}x{MAP_H}", curses.color_pair(4))
    ...
    for y, row in enumerate(grid, start=4):
        ...
        # v1.4.1: limpia la línea antes de redibujar para evitar fantasmas tipo a -> aa -> a.
        try:
            stdscr.move(y, 0)
            stdscr.clrtoeol()
        except curses.error:
...
def draw_log_screen(stdscr, world: World, command_buffer: str, last_output: str) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.4.1 — PANEL", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def draw_ui(stdscr, world: World, command_buffer: str, last_output: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.4.1 — modo médico y supervivencia real", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def choose_map_size_before_start() -> None:
    ...
    """
    clear_screen()
    print(color("EDEN SIM v1.4.1 — Selector de tamaño de mapa", "cyan"))
    print()
...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        clear_screen()
        print_full_legend()
        print(color("NOVEDAD v1.4.1:", "cyan"))
        print("Selector de tamaño de mapa antes de crear el mundo. v1.4.1 corrige colores/fantasmas en mapas pequeños.")
