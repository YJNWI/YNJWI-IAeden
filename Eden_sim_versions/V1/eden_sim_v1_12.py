...
Notas:
    Esta es la versión 1.12 con supervivencia/reproducción mejoradas, maduración acelerada y logs coloreados.
...
class Human:
    ...
    def process_hour(self, world: "World") -> None:
        ...
        self.hunger -= 0.20 * consumption
        self.thirst -= 0.26 * consumption
...
def draw_log_screen(stdscr, world: World, command_buffer: str, last_output: str) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.12 — PANEL", curses.color_pair(4))
    ...
    for line in visible:
        ...
        if line.startswith("REGISTROS"):
            ...
            attr = curses.color_pair(2)  # verde nacimiento natural
        elif "Comando: aparecen" in line and "humano" in line:
            attr = curses.color_pair(4)  # cian spawn humano
...
def draw_ui(stdscr, world: World, command_buffer: str, last_output: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.12 — reproducción y supervivencia", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        clear_screen()
        print_full_legend()
        print(color("NOVEDAD v1.12:", "cyan"))
        print("Si spawneas humanos tras una extinción, el tiempo vuelve a avanzar.")
        print("Reproducción y supervivencia mejoradas: las primeras generaciones priorizan formar sociedad.")
        print("Año inicial: 0.")
