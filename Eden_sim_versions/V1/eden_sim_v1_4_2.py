...
Notas:
    Esta es la versión 1.4.2: selector de tamaño de mapa, estructuras marrones y comandos fluidos safeinput.
...
def draw_overview_screen(stdscr, world: World, command_buffer: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, f"EDEN SIM v1.4.2 — MAPA GLOBAL {MAP_W}x{MAP_H}", curses.color_pair(4))
...
def draw_log_screen(stdscr, world: World, command_buffer: str, last_output: str) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.4.2 — PANEL", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def draw_ui(stdscr, world: World, command_buffer: str, last_output: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.4.2 — modo médico y supervivencia real", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def choose_map_size_before_start() -> None:
    ...
    """
    clear_screen()
    print(color("EDEN SIM v1.4.2 — Selector de tamaño de mapa", "cyan"))
    print()
...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        clear_screen()
        print_full_legend()
        print(color("NOVEDAD v1.4.2:", "cyan"))
        print("Selector de tamaño de mapa antes de crear el mundo. v1.4.2 corrige el fantasma visual con canvas. v1.4.2 corrige el fantasma visual con canvas.")
