...
Notas:
    Esta es la versión 1.12.1 estable: ajuste controlado de sed/hambre y diagnóstico básico sin tocar la interfaz.
...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        clear_screen()
        print_full_legend()
        print(color("NOVEDAD v1.12.1:", "cyan"))
        print("Si spawneas humanos tras una extinción, el tiempo vuelve a avanzar.")
        print("Ajuste estable: sed más realista, mejor instinto de beber y comando quietos.")
        print("Año inicial: 0.")
