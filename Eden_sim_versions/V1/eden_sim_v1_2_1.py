...
Notas:
    Esta es la versión 1.2.1: reparación de comandos/help y río inicial más cerca de la cueva.
...
class World:
    ...
    def generate_river(self) -> None:
        # v1.2.1:
        # El río nace muy cerca del spawn, un poco a la izquierda,
        # para que Adán y Eva puedan verlo desde el primer mapa.
        x = MAP_W // 2 - 7
        ...
        for y in range(MAP_H):
            ...
            if chance(0.38):
                ...
                x = int(clamp(x, MAP_W // 2 - 12, MAP_W // 2 - 3))
    ...
    def place_cave(self) -> None:
        # v1.2.1: cueva fija en el centro.
        # El río queda a pocas casillas a la izquierda.
        x = MAP_W // 2
        y = MAP_H // 2
...
def draw_overview_screen(stdscr, world: World, command_buffer: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.2.1 — MAPA GLOBAL", curses.color_pair(4))
...
def draw_log_screen(stdscr, world: World, command_buffer: str, last_output: str) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.2.1 — PANEL", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def draw_ui(stdscr, world: World, command_buffer: str, last_output: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.2.1 — comandos reparados y río cercano", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        clear_screen()
        print_full_legend()
        print(color("NOVEDAD v1.2.1:", "cyan"))
        print("Si spawneas humanos tras una extinción, el tiempo vuelve a avanzar.")
        print("Arreglados comandos spawn/estadística/help y río inicial visible cerca de la cueva.")
        print("Año inicial: 0.")
