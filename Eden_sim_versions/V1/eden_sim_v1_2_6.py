...
Notas:
    Esta es la versión 1.2.6: T-Rex único y límite de una persona por casilla.
    ...
    def move_to(self, world: "World", target: Tuple[int, int], steps: int = 1) -> None:
        for _ in range(steps):
            ...
            if world.walkable_for_human(nx, ny, human=self):
                ...
                # Si el camino directo está ocupado, prueba una casilla alternativa cercana
                # para evitar quedarse apilado con otros humanos.
                alternative = world.find_free_adjacent_cell(self.x, self.y, radius=1, human=self)
...
def draw_overview_screen(stdscr, world: World, command_buffer: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.2.6 — MAPA GLOBAL", curses.color_pair(4))
...
def draw_log_screen(stdscr, world: World, command_buffer: str, last_output: str) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.2.6 — PANEL", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def draw_ui(stdscr, world: World, command_buffer: str, last_output: str, color_pairs: Dict[int, int]) -> None:
    ...
    addstr_safe(stdscr, 0, 0, "EDEN SIM v1.2.6 — T-Rex único y casillas ocupadas", curses.color_pair(4))
    addstr_safe(stdscr, 1, 0, world_status_string(world), curses.color_pair(1))
...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        clear_screen()
        print_full_legend()
        print(color("NOVEDAD v1.2.6:", "cyan"))
        print("Si spawneas humanos tras una extinción, el tiempo vuelve a avanzar.")
        print("Añadido T-Rex único con spawn trex y límite real de una persona por casilla.")
        print("Año inicial: 0.")
