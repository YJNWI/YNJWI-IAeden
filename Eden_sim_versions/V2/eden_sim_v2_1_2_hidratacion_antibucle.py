...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        ...
        print("v2.1.2 hidratación: agua como prioridad absoluta, emergencia anti-bucle y búsqueda global de río. Para estándar: mapa 3 y puntos 1. v1.4.4 añade río curvo con afluentes.")
