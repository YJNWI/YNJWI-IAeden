...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        ...
        print("v2.1.3 generaciones fuertes: gen 1-5 x2, gen 6 x1.7, gen 7 x1.4, recuperación si población cae <50%. Para estándar: mapa 3 y puntos 1. v1.4.4 añade río curvo con afluentes.")
