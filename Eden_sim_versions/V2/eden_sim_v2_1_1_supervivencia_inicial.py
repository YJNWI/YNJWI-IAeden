...
def help_text() -> str:
    return (
        "AYUDA DE COMANDOS\n"
        "help | status | civilizacion | sociedad | agricultura | aprendizaje | logs | logs 30 | relevantes | relevantes 30 | pause | resume | speed 5 | delay 0.20 | render | mapa | smap | quietos\n"
...
def main() -> None:
    ...
    if SHOW_START_LEGEND:
        ...
        print("v2.1.1 supervivencia inicial: obsesión por dormir seguro, cuevas/árboles, refugios improvisados, reproducción y aprendizaje básico. Para estándar: mapa 3 y puntos 1. v1.4.4 añade río curvo con afluentes.")
